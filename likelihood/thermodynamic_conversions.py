...
def Vs_calc(mu0,dmudT,dmudP,eta0,E,Va,dTdz,sol50,T,dep):
...
def Q_calc(mu0,dmudT,dmudP,eta0,E,Va,dTdz,sol50,Vs,dep):
...
def visc_calc(mu0,dmudT,dmudP,eta0,E,Va,dTdz,sol50,Vs,dep):
